...
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/WACV_Paper/Models_RAW/ResNet50_Diff_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
...
wcw_history_df.to_csv('/WACV_Paper/History/ResNet50_Diff_wCW.csv', index=False)
...
file_path = '/WACV_Paper/Plots_RAW/ResNet50_Diff_wCW_PR_Curve.csv'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/WACV_Paper/Plots_RAW/ResNet50_Diff_wCW_PR_Curve.png'
