...
wcw_history_df.to_csv('/WACV_Paper/History/SqueezeNet_Diff_wCW.csv', index=False)
...
file_path = '/WACV_Paper/Plots_RAW/SqueezeNet_Diff_wCW_PR_Curve.csv'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/WACV_Paper/Plots_RAW/SqueezeNet_Diff_wCW_PR_Curve.png'
